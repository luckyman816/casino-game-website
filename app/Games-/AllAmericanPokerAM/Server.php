                        ...
                        switch( $gameData['slotEvent'] ) 
                        {
                            ...
                            case 'A/u25':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $DealCards = '';
                                    $slotSettings->SetGameData('AllAmericanPokerAMBet', $lastEvent->serverResponse->Bet);
                                    $slotSettings->SetGameData('AllAmericanPokerAMCurrentCards', $lastEvent->serverResponse->CurrentCards);
                                    $slotSettings->SetGameData('AllAmericanPokerAMCards', $lastEvent->serverResponse->Cards);
                                    $slotSettings->SetGameData('AllAmericanPokerAMbalanceFormated', $balanceFormated);
                                    ...
                                    {
                                        if( $slotSettings->Bet[$b] == $slotSettings->GetGameData('AllAmericanPokerAMBet') ) 
                                        {
                                            $betLevel = $b;
                                            break;
                                        }
                            ...
                            case 'A/u250':
                                ...
                                break;
                            case 'A/u253':
                                if( count($slotSettings->GetGameData('AllAmericanPokerAMCards')) <= 1 ) 
                                {
                                    exit();
                                }
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $resultCards0 = $slotSettings->GetGameData('AllAmericanPokerAMCurrentCards');
                                }
                                else
                                {
                                    $resultCards_ = $slotSettings->GetGameData('AllAmericanPokerAMCurrentCards');
                                    $cards = $slotSettings->GetGameData('AllAmericanPokerAMCards');
                                }
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    $totalWin = $cc[0] * $slotSettings->GetGameData('AllAmericanPokerAMBet');
                                    if( $totalWin <= $bank ) 
                                    {
                                        break;
                                    }
                                ...
                                $slotSettings->SetGameData('AllAmericanPokerAMTotalWin', $totalWin);
                                $DealCards = '';
                                for( $i = 0; $i < 5; $i++ ) 
                                {
                                    $DealCards .= ('2' . $resultCards[$i]->suit . dechex($resultCards[$i]->value));
                                ...
                                $slotSettings->SetGameData('AllAmericanPokerAMCollect', $response_collect);
                                $logArr = (object)[
                                    'Bet' => $slotSettings->GetGameData('AllAmericanPokerAMBet'), 
                            ...
                            case 'A/u257':
                                $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                                $response_collect = $slotSettings->GetGameData('AllAmericanPokerAMCollect');
                                $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            case 'A/u251':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    $cc2 = $slotSettings->GetCombination([
                                        $resultCards[0]->value, 
                                        $resultCards[1]->value, 
                                        $resultCards[2]->value, 
                                        $resultCards[3]->value, 
                                ...
                                $slotSettings->SetGameData('AllAmericanPokerAMBet', $allbet);
                                $slotSettings->SetGameData('AllAmericanPokerAMCurrentCards', $resultCards);
                                $slotSettings->SetGameData('AllAmericanPokerAMCards', $cardsArr);
                                $slotSettings->SetGameData('AllAmericanPokerAMbalanceFormated', $balanceFormated);
                                break;
                            case 'A/u2514':
                                $balanceFormated = $slotSettings->GetGameData('AllAmericanPokerAMbalanceFormated');
                                $cardsID = [];
                                $cnt = 0;
                                for( $i = 2; $i <= 14; $i++ ) 
                                {
                                ...
                                $dCard = rand(2, 14);
                                $totalWin = $slotSettings->GetGameData('AllAmericanPokerAMTotalWin');
                                ...
                                $slotSettings->SetGameData('AllAmericanPokerAMDealerCard', $dCard);
                                $slotSettings->SetGameData('AllAmericanPokerAMDealerCardS', $dealerCard);
                                break;
                            case 'A/u2515':
                                $balanceFormated = $slotSettings->GetGameData('AllAmericanPokerAMbalanceFormated');
                                $cardsID = [];
                            ...
                            case 'A/u2513':
                                ...
                                $cWin = $slotSettings->GetGameData('AllAmericanPokerAMTotalWin');
                                $aWin = $cWin * 2;
                                ...
                                if( $isWin == 1 ) 
                                {
                                    $pCard = rand($slotSettings->GetGameData('AllAmericanPokerAMDealerCard'), 14);
                                }
                                else
                                {
                                    $pCard = rand(2, $slotSettings->GetGameData('AllAmericanPokerAMDealerCard'));
                                }
                                if( $slotSettings->GetGameData('AllAmericanPokerAMDealerCard') == $pCard ) 
                                {
                                    $totalWin = $cWin;
                                }
                                else if( $slotSettings->GetGameData('AllAmericanPokerAMDealerCard') < $pCard ) 
                                {
                                    $totalWin = $aWin;
                                }
                                else
                                ...
                                $response = '10d010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . '10001a33e810' . $slotSettings->GetGameData('AllAmericanPokerAMDealerCardS') . $pCardsStr . '0000001723c1d23b21b10101023b21b020100000' . $pSelect . $slotSettings->GetGameData('AllAmericanPokerAMDealerCardS') . '#' . $pCard . '|' . $slotSettings->GetGameData('AllAmericanPokerAMDealerCardS');
                                if( $totalWin <= 0 ) 
                                {
                                    $totalWin = -1 * $cWin;
                                }
                                $response_log = '{"responseEvent":"gambleResult","serverResponse":{"totalWin":' . $totalWin . '}}';
                                $slotSettings->SaveLogReport($response_log, $slotSettings->GetGameData('AllAmericanPokerAMBet'), 1, $totalWin, 'double');
                                break;
                        }
