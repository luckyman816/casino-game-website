    ...
    class SlotSettings
    {
        ...
        public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState)
        {
            ...
            \VanguardLTE\StatGame::create([
                ...
                'balance' => $this->Balance * $this->CurrentDenom, 
<<<<<<< HEAD
                'bet' => $this->toGameBanks, //$bet * $this->CurrentDenom, 
                'win' => $win * $this->CurrentDenom, 
                'game' => $reportName, 
                'in_game' => $this->toGameBanks / 100 * $this->GetPercent() , //$this->toGameBanks, 
                'in_jpg' => $this->toSlotJackBanks, 
                'in_profit' => $this->toGameBanks - $this->toGameBanks / 100 * $this->GetPercent(), // $this->betProfit, 
=======
                'bet' => $bet * $this->CurrentDenom, 
                'win' => $win * $this->CurrentDenom, 
                'game' => $reportName, 
