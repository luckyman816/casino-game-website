<?php 
namespace VanguardLTE\Games\LuckyNewYearTigerTreasuresM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\LuckyNewYear\PragmaticLib\Collect;
    use VanguardLTE\Games\LuckyNewYear\PragmaticLib\GameSettings;
    use VanguardLTE\Games\LuckyNewYear\PragmaticLib\Loader;
    use VanguardLTE\Games\LuckyNewYear\PragmaticLib\Log;
    use VanguardLTE\Games\LuckyNewYear\PragmaticLib\Spin;
    use VanguardLTE\Games\LuckyNewYear\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\LuckyNewYear\PragmaticLib\DoBonus;
