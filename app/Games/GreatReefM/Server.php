<?php 
namespace VanguardLTE\Games\GreatReefM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\GreatReef\PragmaticLib\Collect;
    use VanguardLTE\Games\GreatReef\PragmaticLib\GameSettings;
    use VanguardLTE\Games\GreatReef\PragmaticLib\Loader;
    use VanguardLTE\Games\GreatReef\PragmaticLib\Log;
    use VanguardLTE\Games\GreatReef\PragmaticLib\Spin;
    use VanguardLTE\Games\GreatReef\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\GreatReef\PragmaticLib\DoBonus;
