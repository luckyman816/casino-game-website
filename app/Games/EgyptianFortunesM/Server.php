<?php 
namespace VanguardLTE\Games\EgyptianFortunesM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\EgyptianFortunes\PragmaticLib\Collect;
    use VanguardLTE\Games\EgyptianFortunes\PragmaticLib\GameSettings;
    use VanguardLTE\Games\EgyptianFortunes\PragmaticLib\Loader;
    use VanguardLTE\Games\EgyptianFortunes\PragmaticLib\Log;
    use VanguardLTE\Games\EgyptianFortunes\PragmaticLib\Spin;
    use VanguardLTE\Games\EgyptianFortunes\PragmaticLib\DoMysteryScatter;
