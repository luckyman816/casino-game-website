<?php 
namespace VanguardLTE\Games\JohnHunterAndTheMayanGodsM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\JohnHunterAndTheMayanGods\PragmaticLib\Collect;
    use VanguardLTE\Games\JohnHunterAndTheMayanGods\PragmaticLib\GameSettings;
    use VanguardLTE\Games\JohnHunterAndTheMayanGods\PragmaticLib\Loader;
    use VanguardLTE\Games\JohnHunterAndTheMayanGods\PragmaticLib\Log;
    use VanguardLTE\Games\JohnHunterAndTheMayanGods\PragmaticLib\Spin;
    use VanguardLTE\Games\JohnHunterAndTheMayanGods\PragmaticLib\DoMysteryScatter;
