<?php
namespace VanguardLTE\Games\FruitPartyM
{

    use VanguardLTE\Game;
    use VanguardLTE\Games\FruitParty\PragmaticLib\Collect;
    use VanguardLTE\Games\FruitParty\PragmaticLib\GameSettings;
    use VanguardLTE\Games\FruitParty\PragmaticLib\Loader;
    use VanguardLTE\Games\FruitParty\PragmaticLib\Log;
    use VanguardLTE\Games\FruitParty\PragmaticLib\Spin;
