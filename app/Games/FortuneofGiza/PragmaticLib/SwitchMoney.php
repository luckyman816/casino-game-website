...
class SwitchMoney
{
    ...
    public static function set($pur, $bet, $shop, $bank, $jpgs, $user, $game, $callbackUrl, $win, $slotArea, $fswin, $currentLog, $win_permisson, $fromJP){
        ...
        Statistic::setStatistic($user, $win + $fswin, $game, $bank, $bet, $toSlotBank, $toJackpot, $toProfit, $fswin, $slotArea, $fromJP);
