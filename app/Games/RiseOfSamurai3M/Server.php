<?php 
namespace VanguardLTE\Games\RiseOfSamurai3M
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\WildWestGold\PragmaticLib\Collect;
    use VanguardLTE\Games\WildWestGold\PragmaticLib\GameSettings;
    use VanguardLTE\Games\WildWestGold\PragmaticLib\Loader;
    use VanguardLTE\Games\WildWestGold\PragmaticLib\Log;
    use VanguardLTE\Games\WildWestGold\PragmaticLib\Spin;
    use VanguardLTE\Games\WildWestGold\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\WildWestGold\PragmaticLib\DoBonus;
