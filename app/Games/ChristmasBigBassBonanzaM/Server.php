<?php 
namespace VanguardLTE\Games\ChristmasBigBassBonanzaM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\BigBassBonanza\PragmaticLib\Collect;
    use VanguardLTE\Games\BigBassBonanza\PragmaticLib\GameSettings;
    use VanguardLTE\Games\BigBassBonanza\PragmaticLib\Loader;
    use VanguardLTE\Games\BigBassBonanza\PragmaticLib\Log;
    use VanguardLTE\Games\BigBassBonanza\PragmaticLib\Spin;
    use VanguardLTE\Games\BigBassBonanza\PragmaticLib\DoMysteryScatter;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                {
                    $response = 'SoundState=true_true_true_false_false;FastPlay=false;Intro=true;StopMsg=0;TurboSpinMsg=0;BetInfo=1_2;BatterySaver=false;ShowCCH=false;ShowFPH=true;CustomGameStoredData=;Coins=false;Volume=1;InitialScreen=6,8,5_9,11,6_12,8,9_6,9,6_6,9,6;SBPLock=true';
