<?php 
namespace VanguardLTE\Games\FireStrikeM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\FireStrike\PragmaticLib\Collect;
    use VanguardLTE\Games\FireStrike\PragmaticLib\GameSettings;
    use VanguardLTE\Games\FireStrike\PragmaticLib\Loader;
    use VanguardLTE\Games\FireStrike\PragmaticLib\Log;
    use VanguardLTE\Games\FireStrike\PragmaticLib\Spin;
    use VanguardLTE\Games\FireStrike\PragmaticLib\DoMysteryScatter;
