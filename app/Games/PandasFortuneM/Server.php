<?php 
namespace VanguardLTE\Games\PandasFortuneM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\PandasFortune\PragmaticLib\Collect;
    use VanguardLTE\Games\PandasFortune\PragmaticLib\GameSettings;
    use VanguardLTE\Games\PandasFortune\PragmaticLib\Loader;
    use VanguardLTE\Games\PandasFortune\PragmaticLib\Log;
    use VanguardLTE\Games\PandasFortune\PragmaticLib\Spin;
    use VanguardLTE\Games\PandasFortune\PragmaticLib\DoMysteryScatter;
