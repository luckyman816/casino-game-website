<?php 
namespace VanguardLTE\Games\WildBoosterM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\WildBooster\PragmaticLib\Collect;
    use VanguardLTE\Games\WildBooster\PragmaticLib\GameSettings;
    use VanguardLTE\Games\WildBooster\PragmaticLib\Loader;
    use VanguardLTE\Games\WildBooster\PragmaticLib\Log;
    use VanguardLTE\Games\WildBooster\PragmaticLib\Spin;
    use VanguardLTE\Games\WildBooster\PragmaticLib\DoFSOption;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                if ($action == 'doFSOption'){
                    $response = DoFSOption::doFSOption($user, $game, $request->input('ind'), $index, $counter, $user->balance);
                    exit( $response );
                }
                ///////////////////////////////////////////
