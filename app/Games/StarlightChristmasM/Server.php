<?php
namespace VanguardLTE\Games\StarlightChristmasM
{

    use VanguardLTE\Game;
    use VanguardLTE\Games\GatesofOlympus\PragmaticLib\Collect;
    use VanguardLTE\Games\GatesofOlympus\PragmaticLib\GameSettings;
    use VanguardLTE\Games\GatesofOlympus\PragmaticLib\Loader;
    use VanguardLTE\Games\GatesofOlympus\PragmaticLib\Log;
    use VanguardLTE\Games\GatesofOlympus\PragmaticLib\Spin;
