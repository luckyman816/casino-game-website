        ...
        return [
            "de.edict.eoc.gaming.comm.GameClientActionResponseDTO" => [
                ...
                "gameData" => json_encode([
                    ...
                    "payTable" => [
                        "groups" => [
                            ["members" => [8],"items" => [["winFactor" => 10000,"occur" => 4]]],
                            ["members" => [7],"items" => [["winFactor" => 800,"occur" => 4],["winFactor" => 80,"occur" => 3]]],
                            ["members" => [6],"items" => [["winFactor" => 300,"occur" => 4],["winFactor" => 30,"occur" => 3]]],
                            ["members" => [5],"items" => [["winFactor" => 200,"occur" => 4],["winFactor" => 20,"occur" => 3]]],
                            ["members" => [4,3,2,1],"items" => [["winFactor" => 20,"occur" => 4],["winFactor" => 5,"occur" => 3]]],
                            ["members" => [0],"items" => [["winFactor" => 10,"occur" => 4],["winFactor" => 5,"occur" => 3]]]
                        ]],
                    "wagerPositionSets" => [
                        ["wagerPositionIds" => [1], "type" => "FIXED"]],
