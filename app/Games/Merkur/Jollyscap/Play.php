...
class Play
{
    public static function get($balance, $winnings, $reels, $bet, $totalWin, $params, $finish = false)
    {
            ...
            "gameData" => json_encode([
                "mainGameResult" => [
                    ...
                    "reels" => [
                        ...
                        "2" => ["visibleSymbolCount" => 3,"swingOffSize" => 1,"symbols" => $reels[2], !$params ?: "teaser" => ["id" => 10,"occur" => 1]],
