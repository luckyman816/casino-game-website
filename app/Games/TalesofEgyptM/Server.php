<?php 
namespace VanguardLTE\Games\TalesofEgyptM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\TalesofEgypt\PragmaticLib\Collect;
    use VanguardLTE\Games\TalesofEgypt\PragmaticLib\GameSettings;
    use VanguardLTE\Games\TalesofEgypt\PragmaticLib\Loader;
    use VanguardLTE\Games\TalesofEgypt\PragmaticLib\Log;
    use VanguardLTE\Games\TalesofEgypt\PragmaticLib\Spin;
    use VanguardLTE\Games\TalesofEgypt\PragmaticLib\DoMysteryScatter;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                {
                    $response = 'SoundState=true_true_true_false_false;FastPlay=false;Intro=true;StopMsg=0;TurboSpinMsg=0;BetInfo=0_0;BatterySaver=false;ShowCCH=false;ShowFPH=true;CustomGameStoredData=;Coins=false;Volume=1;InitialScreen=4,5,4_3,6,3_3,2,5_4,4,6_3,3,3;SBPLock=true';
