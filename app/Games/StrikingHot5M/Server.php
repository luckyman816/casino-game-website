<?php 
namespace VanguardLTE\Games\StrikingHot5M
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\StrikingHot5\PragmaticLib\Collect;
    use VanguardLTE\Games\StrikingHot5\PragmaticLib\GameSettings;
    use VanguardLTE\Games\StrikingHot5\PragmaticLib\Loader;
    use VanguardLTE\Games\StrikingHot5\PragmaticLib\Log;
    use VanguardLTE\Games\StrikingHot5\PragmaticLib\Spin;
    use VanguardLTE\Games\StrikingHot5\PragmaticLib\DoMysteryScatter;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                {
                    $response = 'SoundState=true_true_true_false_false;FastPlay=false;Intro=true;StopMsg=0;TurboSpinMsg=0;BetInfo=1_2;BatterySaver=false;ShowCCH=false;ShowFPH=true;CustomGameStoredData=;Coins=false;Volume=1;InitialScreen=3,6,8_7,7,7_7,4,4_6,9,9_6,8,8;SBPLock=true';
