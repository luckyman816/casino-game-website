<?php 
namespace VanguardLTE\Games\BigBassSplashM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\BigBassSplash\PragmaticLib\Collect;
    use VanguardLTE\Games\BigBassSplash\PragmaticLib\GameSettings;
    use VanguardLTE\Games\BigBassSplash\PragmaticLib\Loader;
    use VanguardLTE\Games\BigBassSplash\PragmaticLib\Log;
    use VanguardLTE\Games\BigBassSplash\PragmaticLib\Spin;
    use VanguardLTE\Games\BigBassSplash\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\BigBassSplash\PragmaticLib\DoBonus;
