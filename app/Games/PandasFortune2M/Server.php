<?php 
namespace VanguardLTE\Games\PandasFortune2M
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\PandasFortune2\PragmaticLib\Collect;
    use VanguardLTE\Games\PandasFortune2\PragmaticLib\GameSettings;
    use VanguardLTE\Games\PandasFortune2\PragmaticLib\Loader;
    use VanguardLTE\Games\PandasFortune2\PragmaticLib\Log;
    use VanguardLTE\Games\PandasFortune2\PragmaticLib\Spin;
    use VanguardLTE\Games\PandasFortune2\PragmaticLib\DoMysteryScatter;
