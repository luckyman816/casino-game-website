<?php 
namespace VanguardLTE\Games\MadameDestinyM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\MadameDestiny\PragmaticLib\Collect;
    use VanguardLTE\Games\MadameDestiny\PragmaticLib\GameSettings;
    use VanguardLTE\Games\MadameDestiny\PragmaticLib\Loader;
    use VanguardLTE\Games\MadameDestiny\PragmaticLib\Log;
    use VanguardLTE\Games\MadameDestiny\PragmaticLib\Spin;
    use VanguardLTE\Games\MadameDestiny\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\MadameDestiny\PragmaticLib\DoBonus;
