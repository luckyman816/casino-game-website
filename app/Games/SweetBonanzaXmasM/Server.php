<?php
namespace VanguardLTE\Games\SweetBonanzaXmasM
{

    use VanguardLTE\Game;
    use VanguardLTE\Games\BonanzaGold\PragmaticLib\Collect;
    use VanguardLTE\Games\BonanzaGold\PragmaticLib\GameSettings;
    use VanguardLTE\Games\BonanzaGold\PragmaticLib\Loader;
    use VanguardLTE\Games\BonanzaGold\PragmaticLib\Log;
    use VanguardLTE\Games\BonanzaGold\PragmaticLib\Spin;
