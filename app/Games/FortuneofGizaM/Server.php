<?php 
namespace VanguardLTE\Games\FortuneofGizaM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\FortuneofGiza\PragmaticLib\Collect;
    use VanguardLTE\Games\FortuneofGiza\PragmaticLib\GameSettings;
    use VanguardLTE\Games\FortuneofGiza\PragmaticLib\Loader;
    use VanguardLTE\Games\FortuneofGiza\PragmaticLib\Log;
    use VanguardLTE\Games\FortuneofGiza\PragmaticLib\Spin;
    use VanguardLTE\Games\FortuneofGiza\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\FortuneofGiza\PragmaticLib\DoBonus;
