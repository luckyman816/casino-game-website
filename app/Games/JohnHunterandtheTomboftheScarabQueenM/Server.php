<?php 
namespace VanguardLTE\Games\JohnHunterandtheTomboftheScarabQueenM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\AztecKing\PragmaticLib\Collect;
    use VanguardLTE\Games\AztecKing\PragmaticLib\GameSettings;
    use VanguardLTE\Games\AztecKing\PragmaticLib\Loader;
    use VanguardLTE\Games\AztecKing\PragmaticLib\Log;
    use VanguardLTE\Games\AztecKing\PragmaticLib\Spin;
    use VanguardLTE\Games\AztecKing\PragmaticLib\DoMysteryScatter;
