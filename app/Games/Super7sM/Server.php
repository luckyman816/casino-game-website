<?php 
namespace VanguardLTE\Games\Super7sM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\Super7s\PragmaticLib\Collect;
    use VanguardLTE\Games\Super7s\PragmaticLib\GameSettings;
    use VanguardLTE\Games\Super7s\PragmaticLib\Loader;
    use VanguardLTE\Games\Super7s\PragmaticLib\Log;
    use VanguardLTE\Games\Super7s\PragmaticLib\Spin;
    use VanguardLTE\Games\Super7s\PragmaticLib\DoMysteryScatter;
