<?php 
namespace VanguardLTE\Games\HotToBurnM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\HotToBurn\PragmaticLib\Collect;
    use VanguardLTE\Games\HotToBurn\PragmaticLib\GameSettings;
    use VanguardLTE\Games\HotToBurn\PragmaticLib\Loader;
    use VanguardLTE\Games\HotToBurn\PragmaticLib\Log;
    use VanguardLTE\Games\HotToBurn\PragmaticLib\Spin;
    use VanguardLTE\Games\HotToBurn\PragmaticLib\DoMysteryScatter;
