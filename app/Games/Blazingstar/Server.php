...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if ($command == 'commands') {
                ...
                if (is_array($gameData) && array_key_exists('gameActionId', $gameData) && $gameData['gameActionId'] == 'INIT') {
                    if (!$log) $log = ["Reels" => $settings->randomSlotArea, 'Winnings' => [], 'TotalWin' => 0, 'Bet' => 10];
                ...
                switch ($command) {
                    case 'PLAY':
                        ...
                        list($winnings, $readyReels, $slotArea, $totalWin) = Spin::get($bet, $settings, $bank, $shop->percent, $game->stat_in, $game->stat_out);
                        ...
                        $toLog = ['Winnings' => $winnings, 'Reels' => $readyReels, 'SlotArea' => $slotArea, 'TotalWin' => $totalWin, 'Bet' => $bet];
