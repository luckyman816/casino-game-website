<?php 
namespace VanguardLTE\Games\AncientEgyptClassicM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\AncientEgyptClassic\PragmaticLib\Collect;
    use VanguardLTE\Games\AncientEgyptClassic\PragmaticLib\GameSettings;
    use VanguardLTE\Games\AncientEgyptClassic\PragmaticLib\Loader;
    use VanguardLTE\Games\AncientEgyptClassic\PragmaticLib\Log;
    use VanguardLTE\Games\AncientEgyptClassic\PragmaticLib\Spin;
    use VanguardLTE\Games\AncientEgyptClassic\PragmaticLib\DoMysteryScatter;
