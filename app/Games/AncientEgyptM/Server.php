<?php 
namespace VanguardLTE\Games\AncientEgyptM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\AncientEgypt\PragmaticLib\Collect;
    use VanguardLTE\Games\AncientEgypt\PragmaticLib\GameSettings;
    use VanguardLTE\Games\AncientEgypt\PragmaticLib\Loader;
    use VanguardLTE\Games\AncientEgypt\PragmaticLib\Log;
    use VanguardLTE\Games\AncientEgypt\PragmaticLib\Spin;
    use VanguardLTE\Games\AncientEgypt\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\AncientEgypt\PragmaticLib\DoBonus;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                if ($action == 'doBonus'){
                    ...
                    $response = DoBonus::doBonus($user, $game, $bet, $lines, $log->getLog(), $index, $counter, $request->input('ind'), $bank, $shop, $jpgs);
                    exit( $response );
                }
                ///////////////////////////////////////////
                if( $request['action'] == 'settings' )
                {
                    $response = 'SoundState=true_true_true_false_false;FastPlay=false;Intro=false;StopMsg=0;TurboSpinMsg=0;BetInfo=0_0;BatterySaver=false;ShowCCH=false;ShowFPH=true;CustomGameStoredData=;Coins=false;Volume=1;InitialScreen=8,5,6_4,11,7_8,1,10_10,8,4_6,3,9;SBPLock=true';
