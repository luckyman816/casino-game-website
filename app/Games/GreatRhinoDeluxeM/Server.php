<?php 
namespace VanguardLTE\Games\GreatRhinoDeluxeM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\GreatRhino\PragmaticLib\Collect;
    use VanguardLTE\Games\GreatRhino\PragmaticLib\GameSettings;
    use VanguardLTE\Games\GreatRhino\PragmaticLib\Loader;
    use VanguardLTE\Games\GreatRhino\PragmaticLib\Log;
    use VanguardLTE\Games\GreatRhino\PragmaticLib\Spin;
    use VanguardLTE\Games\GreatRhino\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\GreatRhino\PragmaticLib\DoBonus;
