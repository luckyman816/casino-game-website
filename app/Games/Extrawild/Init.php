            ...
            "de.edict.eoc.gaming.comm.GameClientActionResponseDTO" => [
                ...
                "gameData" => json_encode([
                    "mainGameResult" => [
                        ...
                        "parameters" => array_merge($log['WildParameters'], ["CLIENT_SETTINGS" => json_encode(["coin" => $log['Bet'], "countOfActiveWagerPositions" => $log['Lines']])]),
                        "freeGameRound" => 0,
                        "freeGamesTotal" => 0,
                        "multiplier" => 1,
                    ...
                    "payTable" => [
                        "groups" => [
                            ["members" => [7],"items" => [["winFactor" => 50,"occur" => 3],["winFactor" => 500,"occur" => 4],["winFactor" => 2500,"occur" => 5]]],
                            ["members" => [6,5],"items" => [["winFactor" => 20,"occur" => 3],["winFactor" => 100,"occur" => 4],["winFactor" => 500,"occur" => 5]]],
                            ["members" => [0,1,2],"items" => [["winFactor" => 10,"occur" => 3],["winFactor" => 20,"occur" => 4],["winFactor" => 100,"occur" => 5]]],
                            ["members" => [3,4],"items" => [["winFactor" => 10,"occur" => 3],["winFactor" => 40,"occur" => 4],["winFactor" => 200,"occur" => 5]]],
                            ["members" => [8],"items" => [["winFactor" => 10,"occur" => 1]]]]
                    ],
                    "wagerPositionSets" => [
                    ...
                    "translations" => [
                        ...
                        "if_img_not_substituting" => "wenn [WILD] nicht ersetzt",
