<?php 
namespace VanguardLTE\Games\VampiresvsWolvesM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\VampiresvsWolves\PragmaticLib\Collect;
    use VanguardLTE\Games\VampiresvsWolves\PragmaticLib\GameSettings;
    use VanguardLTE\Games\VampiresvsWolves\PragmaticLib\Loader;
    use VanguardLTE\Games\VampiresvsWolves\PragmaticLib\Log;
    use VanguardLTE\Games\VampiresvsWolves\PragmaticLib\Spin;
    use VanguardLTE\Games\VampiresvsWolves\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\VampiresvsWolves\PragmaticLib\DoBonus;
