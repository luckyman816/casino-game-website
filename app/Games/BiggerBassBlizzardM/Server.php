<?php 
namespace VanguardLTE\Games\BiggerBassBlizzardM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\BiggerBassBonanza\PragmaticLib\Collect;
    use VanguardLTE\Games\BiggerBassBonanza\PragmaticLib\GameSettings;
    use VanguardLTE\Games\BiggerBassBonanza\PragmaticLib\Loader;
    use VanguardLTE\Games\BiggerBassBonanza\PragmaticLib\Log;
    use VanguardLTE\Games\BiggerBassBonanza\PragmaticLib\Spin;
    use VanguardLTE\Games\BiggerBassBonanza\PragmaticLib\DoMysteryScatter;
