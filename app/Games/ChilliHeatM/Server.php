<?php 
namespace VanguardLTE\Games\ChilliHeatM
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\ChilliHeat\PragmaticLib\Collect;
    use VanguardLTE\Games\ChilliHeat\PragmaticLib\GameSettings;
    use VanguardLTE\Games\ChilliHeat\PragmaticLib\Loader;
    use VanguardLTE\Games\ChilliHeat\PragmaticLib\Log;
    use VanguardLTE\Games\ChilliHeat\PragmaticLib\Spin;
    use VanguardLTE\Games\ChilliHeat\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\ChilliHeat\PragmaticLib\DoBonus;
