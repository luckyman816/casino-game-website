<?php
namespace VanguardLTE\Games\WildBeachPartyM
{

    use VanguardLTE\Game;
    use VanguardLTE\Games\FruitParty2\PragmaticLib\Collect;
    use VanguardLTE\Games\FruitParty2\PragmaticLib\GameSettings;
    use VanguardLTE\Games\FruitParty2\PragmaticLib\Loader;
    use VanguardLTE\Games\FruitParty2\PragmaticLib\Log;
    use VanguardLTE\Games\FruitParty2\PragmaticLib\Spin;
