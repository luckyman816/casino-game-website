<?php 
namespace VanguardLTE\Games\Piggie7M
{

     use VanguardLTE\Game;
    use VanguardLTE\Games\Piggie7\PragmaticLib\Collect;
    use VanguardLTE\Games\Piggie7\PragmaticLib\GameSettings;
    use VanguardLTE\Games\Piggie7\PragmaticLib\Loader;
    use VanguardLTE\Games\Piggie7\PragmaticLib\Log;
    use VanguardLTE\Games\Piggie7\PragmaticLib\Spin;
    use VanguardLTE\Games\Piggie7\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\Piggie7\PragmaticLib\DoBonus;
