...
serverConfig = JSON.parse(
    fs.readFileSync("../public/socket_config2.json", "utf8")
);
    ...
    request(options, function (err, res, body) {
        ...
        if (sAnswer.action == "Act18") {
            ...
            if (sAnswer.serverResponse.payload != undefined) {
                ...
                responsePacket.writeUint32(
                    payload.serverResponse.totalFreeGames
                );
        ...
        if (sAnswer.action == "Act27") {
            var abc = hexToArrayBuffer(
                ""
            );
        ...
        if (sAnswer.action == "Act25") {
            var abc = hexToArrayBuffer(
                ""
            );
        ...
        if (sAnswer.action == "Act26") {
            var abc = hexToArrayBuffer(
                ""
            );
        ...
        if (sAnswer.action == "Act21") {
            var abc = hexToArrayBuffer(
                "0100120000004b000800280000002c1d00000100002c1d000000000000ffffffff2a51fd3c00000000"
            );
        ...
        if (sAnswer.action == "Act19") {
            ...
            var abc = hexToArrayBuffer(
                "010012000000ff014d00080304020b0908020b0a0a0703030500" +
                insertBytes +
                "000000000000000000000000000000000000002e0f000000000000000000000000000000000000cf0e000000000000e583a25c0100002e0f000000000000ffffffffb37d203300000000"
            );
      ...
      */
        ...
        if (sAnswer.action == "Act20") {
            ...
            var abc = hexToArrayBuffer(
                ""
            );
...
wss.on("connection", function connection(ws) {
    ...
    ws.on("message", function incoming(message) {
        ...
        if (ws.msgId == 0) {
            ...
            var ab = hexToArrayBuffer(
                "010014000000840a00000000000000000000e3c82a5c00000000"
            );
            var params = {};
            ...
            var ab = hexToArrayBuffer(
                "01003a0000004803000003005553440100000001000000605e9f0500000000"
            );
            var params = {};
            params.msgId = ws.msgId;
            params.action = "Init2";
            ...
            var ab = hexToArrayBuffer(
                "010029000000000000000000000032be05000000000014f4c4fd00000000"
            );
            ...
            var ab = hexToArrayBuffer(
                "01003d00000064000000840a000000000000000000004803000003005553440100000001000000651404db00000000"
            );
            ...
            if (messageView8[6] == 54) {
                var ab = hexToArrayBuffer(
                    "01003600000002a40e0000000000008813000000000000071800000000000010270000000000008b2a000000000000204e000000000000bb5d00000000000050c30000000000000f004a41434b504f5420252e326c662020019cbbb21700000000"
                );
                var params = {};
                params.msgId = ws.msgId;
                params.action = "Ping";
            ...
            if (messageView8[6] == 41) {
                var ab = hexToArrayBuffer(
                    "010029000000840a00000000000032be05000000000014f4c4fd00000000"
                );
            ...
            if (messageView8[6] == 61) {
                var ab = hexToArrayBuffer(
                    "01003d00000001000000560f0000000000000000000048030000030055534401000000010000003861720700000000"
                );
            ...
            if (messageView8[6] == 18) {
                if (messageView8.length >= 64) {
                    var ab = hexToArrayBuffer(
                        "010012000000ff014d00080304020b0908020b0a0a0703030500000000000000000000000000000000000000002e0f000000000000000000000000000000000000cf0e000000000000e583a25c0100002e0f000000000000ffffffffb37d203300000000"
                    );

                    var msgString = DecodeMessage(message);

                    var msgJson = JSON.parse(
                        msgString.split("::")[1].split("###")[0]
                    );
                    ...
                    var ab = hexToArrayBuffer(
                        "010012000000ff015e00000000000000000032be0500ff0100000000000048003008d1a12800000001000000be00000000000000560f0000060200080b050509090a0a06080005000000000000000000000000000000000000000000000000000000000001000000560f000000000000ffffffff23f747b200000000"
                    );

                    if (ws.gameName == "HaresRevengeMN") {
                        var ab = hexToArrayBuffer(
                            "01001200000007025e00000000000000000032be0500070200000000000048003008d1a10a0000000100000000000000000000005a1d00000306080900090607090009060603070000000000000000000000000000000000000000000000000000000000010000005a1d000000000000ffffffff4139a60200000000"
                        );
                    }

                    if (ws.gameName == "EmeraldCityMN") {
                        var ab = hexToArrayBuffer(
                            ""
                        );
                    }
