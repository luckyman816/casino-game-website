            ...
            <div class="box-body">
                <div class="row">
                    <form action="" method="GET" id="users-form">
                        ...
                        <div class="col-md-6">
                            {!! Form::select('status', ['' => 'All', '0' => 'Disabled', '1' => 'Active'], Request::get('status'), [
                                'id' => 'status',
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right box-tools">
                    @permission('api.add')
                        <a href="{{ route('backend.api.create') }}"
                            class="btn btn-block btn-primary btn-sm">@lang('app.add')</a>
                    @endpermission
                </div>
            </div>
            <div class="box-body">
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('app.update_endpoint')</th>
                                <th>@lang('app.get_endpoint')</th>
                                <th>@lang('app.shop')</th>
