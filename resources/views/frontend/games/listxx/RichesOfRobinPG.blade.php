...
<head>
    ...
    <script
        src="/games/{{ $game->name }}/Content/javascript/iframedviewbundle.js?v=tJUK0sRqffA6JJcmuSsr62rlQLjtksSZdk1zn3cE4Mk1">
    </script>
    ...
    <script>
        ...
        PngPreloader = {
            ...
            init: function() {
                ...
                var cssPath =
                    "/games/{{ $game->name }}/Content/css/preloader/preloader.css?v=mwkf9h8L--BP7RhC3gPsOK0KwIHwP4bEalzVqW27Vm01";
            ...
            getRemainingDisplayTime: function() {
                if (this.loaderStartLoadStamp === null || this.loaderMinShowDuration === null || this
                    .loaderMinShowDuration <= 0)
                    return 0;
    ...
    <div id="pngPreloaderWrapper" class="png-white-text">
        ...
        <script>
            PngPreloader.initImplementation = function() {
                ...
                var cssPath =
                    "/games/{{ $game->name }}/Content/css/preloader/pngpreloader.css?v=V6VZEXUZcK-vvmoXPyzYJT82_-ZAYXqaqRDvUUOlPV81";
...
<script type="text/javascript">
    ...
    GameLauncher = {
        loadGame: function() {
            ...
            var src =
                '/games/{{ $game->name }}/Casino/GameLoader.js?div=pngCasinoGame&isbally=False&fullscreenmode=False&rccurrentsessiontime=0&rcintervaltime=0&autoplaylimits=0&autoplayreset=0&resourcelevel=0&hasJackpots=False&defaultsound=False&showPoweredBy=False';
