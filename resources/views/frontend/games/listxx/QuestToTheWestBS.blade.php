...
<head>
    ...
    <script>
        ...
        function openHelpHTML2() {
            window.open("/games/{{ $game->name }}/help2.jsp?PARAMS=833;675;USD;en", "mywindow",
                "menubar=0,toolbar=0,location=0,resizable=1,status=1,scrollbars=1,width=1024px,height=768px");
        }
