...
<body onload="ResizeHandler();" style="margin:0px;width:100%;background-color:black;overflow:hidden">
    ...
    <iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;"
        src='/games/VikingsNET/games/vikings-client/game/vikings-client.xhtml?flashParams.bgcolor=000000&gameId=vikings-client&mobileParams.lobbyURL=&server=&lang=en&sessId=DEMO-3901711636-EUR&lang=en&sessId=&operatorId=netent'
        allowfullscreen>
