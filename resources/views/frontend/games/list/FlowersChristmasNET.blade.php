...
<body onload="ResizeHandler();" style="margin:0px;width:100%;background-color:black;overflow:hidden">
    ...
    <iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;"
        src='/games/FlowersChristmasNET/games/flowerschristmas_mobile_html/game/flowerschristmas_mobile_html.xhtml?flashParams.bgcolor=000000&gameId=flowerschristmas_mobile_html&mobileParams.lobbyURL=&server=/&lang=en&sessId=&operatorId=netent'
        allowfullscreen>
