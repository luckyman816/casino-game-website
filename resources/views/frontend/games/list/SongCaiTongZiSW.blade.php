...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="76x76"
        href="assets/favicon/apple-touch-icon-76x76-precomposed.png" />
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
        href="assets/favicon/apple-touch-icon-114x114-precomposed.png" />
    <link rel="apple-touch-icon-precomposed" sizes="120x120"
        href="assets/favicon/apple-touch-icon-120x120-precomposed.png" />
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
        href="assets/favicon/apple-touch-icon-144x144-precomposed.png" />
    <link rel="apple-touch-icon-precomposed" sizes="152x152"
        href="assets/favicon/apple-touch-icon-152x152-precomposed.png" />
    ...
    <link rel="apple-touch-icon-precomposed" sizes="167x167"
        href="assets/favicon/apple-touch-icon-167x167-precomposed.png" />
    <link rel="apple-touch-icon" sizes="180x180" href="assets/favicon/apple-touch-icon.png" />
    <link rel="apple-touch-icon-precomposed" sizes="180x180"
        href="assets/favicon/apple-touch-icon-180x180-precomposed.png" />
    ...
    <script>
        ...
        if (document.location.href.split("?")[1] == undefined) {
            document.location.href = document.location.href +
                '/?hide_play_for_real=true&startGameToken=&language=en&url=&bns=0&useCookie=true&swa=1&history=0&history_url=index.html&playmode=real&merch_login_url=';
        }
    </script>
</head>
        ...
        ! function(e, n, t) {
            ...
            function i(e, n, t) {
                ...
                a.open("GET", e + "?" + Date.now()), a.onreadystatechange = function() {
                    4 === a.readyState && (200 === a.status && "0" !== a.getResponseHeader("Content-Length") ? n(a
                        .responseText) : t())
                }, a.send()
            }
            ...
            function p(n, o) {
                var s = "wrapper/" + n + "/",
                    ...
                    p = s + "wrapper-" + (/\bandroid\b/.test(i) && -1 === i.indexOf("windows nt") || "iP" === t.platform
                        .slice(0, 2) || /ip(hone|od|ad)/.test(i) ? "mobile" : "desktop") + ".min";
                e.Promise || a(s + "es6-promise.min"), e.fetch || a(s + "fetch.min"), Object.assign || a(s +
                    "object.assign.min"), r(p + ".css"), a(p, "wrapper", o)
            }
