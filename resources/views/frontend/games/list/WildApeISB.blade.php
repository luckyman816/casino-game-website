 ...
 <body style="margin:0px;width:100%;background-color:black;overflow:hidden">
     ...
     <iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;"
         src='/games/WildApeISB/pulse_wild_ape.html?name=255,fun&password=fun&lang=en&currency=&funmode=true&rulesUrl=&skinid=200203&channelautodetection=ON&allowFullScreen=true&cachebuster=cef08a523e42f0feba6271b0d0152677c9016bd9&enableConsole=false&newSkinIDFormat=true'
         allowfullscreen>
