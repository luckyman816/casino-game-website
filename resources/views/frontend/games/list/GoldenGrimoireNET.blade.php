...
<body onload="ResizeHandler();" style="margin:0px;width:100%;background-color:black;overflow:hidden">
    ...
    <iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;"
        src='/games/GoldenGrimoireNET/games/goldengrimoire-client/game/goldengrimoire-client.xhtml?flashParams.bgcolor=000000&gameId=goldengrimoire-client&mobileParams.lobbyURL=&server=/&lang=en&sessId=&operatorId=netent'
        allowfullscreen>
