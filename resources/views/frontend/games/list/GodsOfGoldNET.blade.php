...
<body onload="ResizeHandler();" style="margin:0px;width:100%;background-color:black;overflow:hidden">
    ...
    <iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;"
        src='/games/{{ $game->name }}/games/godsofgold-client/game/godsofgold-client.xhtml?flashParams.bgcolor=000000&gameId=godsofgold_not_mobile&mobileParams.lobbyURL=&server=/game/{{ $game->name }}/server&lang=en&sessId=DEMO-3901711636-EUR&operatorId=netent'
        allowfullscreen>
