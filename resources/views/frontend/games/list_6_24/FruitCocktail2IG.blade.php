...
<body style="margin:0px;width:100%;background-color:black;overflow:hidden">
        ...
        addEventListener('message', function(ev) {
            ...
            if (ev.data == 'CloseGame') {
                ...
                if (window != window.top || document != top.document || self.location != top.location) {
                    var isFramed = false;
                    try {
                        isFramed = window != window.top || document != top.document || self.location != top
                            .location;
                    } catch (e) {
                        isFramed = true;
                    }
    ...
    <iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;"
        src='/games/FruitCocktail2IG/index.html?curr=@if (auth()->user()->present()->shop) {{ auth()->user()->present()->shop->currency }} @endif&lang=en'
        allowfullscreen>
