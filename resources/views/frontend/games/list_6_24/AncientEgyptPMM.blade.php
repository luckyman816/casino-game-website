...
<head>
    ...
    <script>
        ...
        window.onerror = function(messageOrEvent, source, lineno, colno) {
            ...
            if (messageOrEvent instanceof Event)
                args = [messageOrEvent["message"], messageOrEvent["fileName"], messageOrEvent["lineNumber"],
                    messageOrEvent["columnNumber"]
                ];
            else
        ...
        window.onbeforeunload = function() {
            ...
            ga('LoadingTracker.send', 'event', "uht_loading", "_CLOSED_error_" + step, URLGameSymbol, UHT_HAD_ERRORS ?
                1 : 0);
            ...
            if (GA_timer_load_start != undefined)
                ga('LoadingTracker.send', 'timer', "uht_loading", "_CLOSED_at_1", URLGameSymbol, new Date().getTime() -
                    GA_timer_load_start);
        ...
        ! function(i, s) {
            var e = "0.7.10",
                ...
                k = {
                    extend: function(i, s) {
                        var e = {};
                        for (var o in i) e[o] = s[o] && s[o].length % 2 === 0 ? s[o].concat(i[o]) : i[o];
                        return e
                    },
                    has: function(i, s) {
                        ...
                        for (var i, e, o, r, w, l, d, p = 0, c = arguments; p < c.length && !l;) {
                            ...
                            for (e = o = 0; e < u.length && !l;)
                                if (l = u[e++].exec(this.getUA()))
                                    for (r = 0; r < m.length; r++) d = l[++o], w = m[r], typeof w === t && w.length >
                                        0 ? 2 == w.length ? i[w[0]] = typeof w[1] == n ? w[1].call(this, d) : w[1] :
                                        3 == w.length ? i[w[0]] = typeof w[1] !== n || w[1].exec && w[1].test ? d ? d
                                        .replace(w[1], w[2]) : s : d ? w[1].call(this, d, w[2]) : s : 4 == w.length &&

                                        (i[w[0]] = d ? w[3].call(this, d.replace(w[1], w[2])) : s) : i[w] = d ? d : s;
                            p += 2
                        }
                        return i
                    },
                ...
                S = {
                    browser: [
                        ...
                        [/(swiftfox)/i,
                            ...
                            /(links)\s\(([\w\.]+)/i, /(gobrowser)\/?([\w\.]+)*/i, /(ice\s?browser)\/v?([\w\._]+)/i,
                            /(mosaic)[\/\s]([\w\.]+)/i
                        ],
                        [p, m]
                    ],
                    ...
                    device: [
                        ...
                        [/\s(milestone|droid(?:[2-4x]|\s(?:bionic|x2|pro|razr))?(:?\s4g)?)[\w\s]+build\//i,
                            /mot[\s-]?(\w+)*/i, /(XT\d{3,4}) build\//i, /(nexus\s[6])/i
                        ],
                        [d, [u, "Motorola"],
                            [c, g]
                        ],
                        ...
                        [/((s[cgp]h-\w+|gt-\w+|galaxy\snexus|sm-n900))/i, /(sam[sung]*)[\s-]*(\w+-?[\w-]*)*/i,
                            /sec-((sgh\w+))/i
                        ],
                        [
                            [u, "Samsung"], d, [c, g]
                        ...
                        [/android.+(\w+)\s+build\/hm\1/i, /android.+(hm[\s\-_]*note?[\s_]*(?:\d\w)?)\s+build/i,
            ...
            T.VERSION = e, T.BROWSER = {
...

                {
                    ...
                    NAME: p,
                    VERSION: m
                }, typeof exports !== a ? (typeof module !== a && module.exports && (exports = module.exports = T), exports
                    .UAParser2 = T) : typeof define === n && define.amd ? define("ua-parser-js", [], function() {
                    return T
                }) : i.UAParser2 = T;
        ...
        var LowEndDeviceIdentifiers = ["S III", "GT-I9300", "iPhone 5", "iPhone 5C", "iPhone 5S", "iPhone 6",
            "iPhone 6 Plus"
        ];
        var UHTConsole = {};
        ...
        UHTConsole.AllowToWrite = function(allowToWrite) {
            ...
            for (var i = 0; i < UHTConsole.methods.length; ++i) {
                ...
                if (!allowToWrite)
                    if (UHTConsole.replacement[name] == null) UHTConsole.replacement[name] = UHTConsole.GetReplacement(
                        i);
            ...
            if (allowToWrite && !UHTConsole.allowToWrite) {
                for (var i =
                        ...
                        0; i < UHTConsole.messages.length; ++i) console[UHTConsole.messages[i].type](UHTConsole
                    .messages[i].args[0]);
                UHTConsole.messages = []
            }
        ...
        UHTConsole.RedirectOutput = function(redirectOutput) {
            ...
            if (redirectOutput) {
                ...
                for (var i = 0; i < UHTConsole.messages.length; ++i) console[UHTConsole.messages[i].type](UHTConsole
                    .messages[i].args[0]);
                UHTConsole.messages = []
            } else {
        ...
        Loader.LoadWURFL = function() {
            Loader.LoadScript("/games/AncientEgyptPMM/wurfl_.js", Loader.WURFLLoadHandler, Loader.WURFLErrorHandler);
            ...
            if (device != undefined)
                for (var id in LowEndDeviceIdentifiers)
                    if (device.indexOf(LowEndDeviceIdentifiers[id]) >= 0) {
                        UHT_LOW_END_DEVICE = true;
                        break
                    } var classNames = [document.documentElement.className || "", os, device, String(UHT_UA_INFO.browser
                .name).replace(/\s/g, ""), UHT_CONFIG.MINI_MODE ? "MiniMode" : "StandardMode"];
        ...
        Loader.LoadGame = function() {
            ...
            if (UHT_ALL && !PLATFORM_APPENDED) {
                UHT_CONFIG.GAME_URL += (UHT_CONFIG.MINI_MODE ? "mini" : UHT_DEVICE_TYPE.MOBILE ? "mobile" : "desktop") +
                    "/";
                UHT_CONFIG.GAME_URL_ALTERNATIVE += (UHT_CONFIG.MINI_MODE ? "mini" : UHT_DEVICE_TYPE.MOBILE ? "mobile" :
                    "desktop") + "/";
            ...
            var script = Loader.LoadScript(UHT_CONFIG.GAME_URL + "bootstrap.js", Loader.LoadGameCallback, function() {
                ...
                if (currentDatapathRetries == retriesBeforeAlternativeDatapath) {
                    ...
                    window["ga"]("LoadingTracker.send", "event", "uht_loading", "_USED_ALTERNATIVE_DATA_PATH",
                        window["URLGameSymbol"], 1)
                }
        ...
        Loader.Listener = function(json) {
            ...
            if (params["common"] == "EVT_GET_CONFIGURATION") {
                ...
                if (UHT_CONFIG.GAME_URL_ALTERNATIVE == undefined) UHT_CONFIG.GAME_URL_ALTERNATIVE = args["config"][
                    "datapath"
                ];
                ...
                if (statURL != undefined) {
                    Loader.statisticsURL = statURL + (/\?/.test(statURL) ? "&" :

                        "?") + "mgckey=" + args["config"]["mgckey"];
        ...
        Loader.SendStatistics = function(params) {
            ...
            xhr.open("POST", Loader.statisticsURL + "&channel=" + (UHT_CONFIG.MINI_MODE ? "mini" : "") + (
                UHT_DEVICE_TYPE.MOBILE ? "mobile" : "desktop") + (UHT_CONFIG.LOBBY_LAUNCHED ? "_mini_lobby" :
                ""), true);
    ...
    <script type="text/javascript" src="/games/AncientEgyptPMM/common/js/html5-script-external.js"></script>
    <script type="text/javascript" src="/games/AncientEgyptPMM/addon.js"></script>
    ...
    <script type="text/javascript">
        Html5GameManager.init({
            ...
            gameConfig: '{"datapath":"/games/AncientEgyptPMM/common/games-html5/games/vs/vs10egypt/","LOGOUT":"/gs2c/logout.do","REGULATION":"/games/AncientEgyptPMM/stats2.do","showRealCash":"1","statisticsURL":"/games/AncientEgyptPMM/stats.do","accountType":"R","jurisdiction":"99","demoMode":"1","RELOAD_JACKPOT":"/gs2c/jackpot/reload.do","clock":"0","styleName":"generic","SETTINGS":"/gs2c/saveSettings.do","mgckey":"stylename@generic~SESSION@4c09aab5-9dae-4531-89e5-3ef75b6dc836","gameService":"https://ttrt/gs2c/v3/gameService","RELOAD_BALANCE":"/gs2c/reloadBalance.do","currencyOriginal":"USD","vendor":"T","extend_events":"1","currency":"USD","lang":"en","CLOSE_GAME":"/gs2c/closeGame.do?symbol\u003dvs10egypt","region":"Other"}',

            mgckey: "stylename@generic~SESSION@4c09aab5-9dae-4531-89e5-3ef75b6dc836",
