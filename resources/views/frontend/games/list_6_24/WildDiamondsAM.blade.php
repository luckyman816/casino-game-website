...
<body style="margin:0px;width:100%;background-color:black;overflow:hidden">
    ...
    <iframe id='game' style="position:fixed;top:0px;margin:0px;border:0px;width:100%;height:100vh;"
        src='/games/WildDiamondsAM/mobile/wilddiamonds.html/?curr=@if (auth()->user()->present()->shop) {{ auth()->user()->present()->shop->currency }} @endif&lang=en&w=&lang=en'
        allowfullscreen>
...
<script>
    ...
    if (document.location.href.split("?")[1] == undefined) {
        document.location.href = document.location.href +
            '/?curr=@if (auth()->user()->present()->shop){{ auth()->user()->present()->shop->currency }}@endif&lang=en&w=&lang=en';
