...
<body>
    ...
    <script type="text/javascript">
        ...
        var SELSVRURL = location.protocol + '//' + location.hostname + '/game/{{ $game->name }}/server?sessionId=' +
            sessionStorage.getItem('sessionId'); // 选服接口
        ...
        window.onresize = function onresize() {
            ...
            if (bw > bh) {
                ...
                $('#loader').css({
                    ...
                    'transform': 'rotate(90deg) translate(' + ((width - height) / 2) + 'px,' + ((width -
                        height) / 2) + 'px)',
