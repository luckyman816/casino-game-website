...
<head>
    ...
    <script type="text/javascript" src="index.js?67d0e31f16217692538c"></script>
</head>
<script>
    if (true) {
    ...
    var qstr =
        '/?launcher=true&sfx_289112219=1613355678748&commonVersion=(build%2085)&game=174&userId=0&wshost=&quality=high&lang=en&noframe=yes';
