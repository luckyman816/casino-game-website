...
<body>
    ...
    <div class="game-box">
        ...
        <div id="game" style="margin: auto;" class="egret-player" data-entry-class="Main"
            data-orientation="landscape" data-scale-mode="exactFit" data-frame-rate="30" data-content-width="1136"
            data-content-height="640" data-show-paint-rect="false" data-multi-fingered="2" data-show-fps="false"
    ...
    <script>
        ...
        if (window.location.protocol == 'https:') {
            ...
            SELSVRURL = 'https://' + hostname + "/game/{{ $game->name }}/server?sessionId=" + sessionStorage.getItem(
                'sessionId') + "&command=init";

        } else {

            WEBSOCKETURL = 'ws://' + hostname;

            SELSVRURL = 'http://' + hostname + "/game/{{ $game->name }}/server?sessionId=" + sessionStorage.getItem(
                'sessionId') + "&command=init";
