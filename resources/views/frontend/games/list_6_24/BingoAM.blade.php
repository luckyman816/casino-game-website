    ...
    <script>
        ...
        if (document.location.href.split("?api_exit")[1] != undefined) {
            ...
            document.location.href = uparts[0] +
                '/?game=keno&hash=&lang=en&protokol=wss&server=&port=&socket=&exit=&balanceInCash=1&m=&w=w1&curr=@if (auth()->user()->present()->shop){{ auth()->user()->present()->shop->currency }}@endif&' +
                uparts[1];
        }
