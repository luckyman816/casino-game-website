                    ...
                    <div class="main-content__first-screen">
                        ...
                        <div class="main-content__latest-winners last-winners ng-isolate-scope">
                            ...
                            <ul class="last-winners__list ng-scope">
                                @if(count($games) > 0)
                                @for ($i = 0;$i < 5;$i++) @php $g=$games[(int)(rand(0, count($games)-1))]; $p=['Samuel J','Robert R ',' Macy L','Jimmy TM','The Ace','Lenny L','Killer Player','Margerie M','Stiff T','Pinnacle Gamer','Jeanette P','Gordon R', 'Mary E' , 'Daniel R' , 'Sumit A' ]; @endphp <li class="last-winners__item ng-scope">
