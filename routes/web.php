...
Route::namespace('Frontend')->middleware(['siteisclosed', 'checker'])->group(function () {
    ...
    */
    ...
    // For Game Api
    // Route::get('api/game/', [
    //     'as' => 'frontend.game.api.go',
    //     'uses' => 'GamesController@goAPI'
    // ]);
    // Route::get('api/{game}', ['as' => 'player.game.run', 'uses' => 'GamesController@runGame']);
    Route::get('api/{game}', ['as' => 'player.game.run', 'uses' => 'PlayersController@runGame']);
    Route::post('api/getGameLaunch',['as'=>'player.game.launch','uses'=>'PlayersController@getGameLaunch']);
    Route::post('game/{game}/server', ['as' => 'player.game.server', 'uses' => 'PlayersController@runServer']);
...
Route::get('get/game-category', [
    'uses' => 'Frontend\GamesController@getGameCategory'
]);

Route::post('get/game-list', [
    'uses' => 'Frontend\GamesController@getGameList',
]);

Route::post('get/register', [
    'uses' => 'Frontend\Auth\AuthController@postAPIRegister'
]);
...
Route::prefix('backend')
    ->middleware(['auth', 'checker'])->group(function () {
        Route::namespace('Backend')->group(function () {
            ...
            Route::get('/', [
                'as' => 'backend.dashboard', 'uses' => 'DashboardController@index',
                //
            ]);
